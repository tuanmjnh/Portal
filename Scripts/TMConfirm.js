        ...
        return $(this).each(function () {
            ...
            $this.off('click').on('click', function (e) {
                ...
                $(modal).find('.btn.btn-primary').on('click', function () {
                    if (typeof DF.modalOk == 'function') DF.modalOk($this);
                });
                //
                $(modal).find('.btn.btn-default').on('click', function () {
                    if (typeof DF.modalCancel == 'function') DF.modalCancel($this);
                });
                //
                $(modal).on('show.bs.modal', function (e) {
                    if (typeof DF.modalShow == 'function') DF.modalShow($this);
                });
                //
                $(modal).on('hidden.bs.modal', function (e) {
                    modal.remove();
                    if (typeof DF.modalHidden == 'function') DF.modalHidden($this);
                });
